if [ ! "$(GET_PROP "system" "ro.projectdozg.version")" ]; then
    SET_PROP "system" "ro.projectdozg.version" "$ROM_VERSION"
fi
...
LOG_STEP_IN "- Adding ProjectDozG Settings"
...
# Add ProjectDozG Settings SearchIndexDataProvider(s)
